  ...
  return (
    <div>
      ...
      >
        <AnimatePresence mode="popLayout">
          {filteredProducts.map((product, idx) => (
            ...
            >
              <div
                className="group rounded-3xl overflow-hidden flex flex-col h-full transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl"
                style={{
                  background: "#26342C",
              ...
              >
                <div className="relative aspect-square overflow-hidden">
                  ...
                  <span
                    className="absolute top-3 left-3 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider text-[#1C2820]"
                    style={{
                      background: "linear-gradient(135deg,#C9A84C,#E8C875)",
                    }}
                  >
                ...
                <div className="p-5 flex-grow flex flex-col justify-between gap-4">
                  ...
                  >
                    ...
                    <ArrowRight
                      className={`w-3.5 h-3.5 transition-transform group-hover/btn:translate-x-1 ${isAr ? "rotate-180" : ""}`}
                    />
                  </Link>
                </div>
              </div>
      ...
      {filteredProducts.length === 0 && (
        <div
          className="text-center py-24 rounded-3xl mt-8"
          style={{
            background: "#26342C",
        ...
        >
          ...
          <p className="text-[#F0EDE8]/40 font-semibold text-sm">
            {isAr
              ? "لا توجد منتجات متوفرة في هذا القسم."
