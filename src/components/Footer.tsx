...
export default function Footer({ locale }: FooterProps) {
  ...
  const categories = [
    ...
    { label: t("products_page.filter_industrial"), href: "/products?cat=industrial" },
  ];

  return (
    <footer style={{ background: "#162018", borderTop: "1px solid rgba(201,168,76,0.18)" }}>

      {/* CTA Banner */}
      <div className="relative overflow-hidden"
        style={{ background: "linear-gradient(135deg,#1F5E3B,#0F3020)", borderBottom: "1px solid rgba(201,168,76,0.15)" }}>
        <div className="absolute inset-0 pointer-events-none"
          style={{ backgroundImage: "radial-gradient(ellipse 40% 60% at 80% 50%, rgba(201,168,76,0.08), transparent)" }} />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-white/50 mt-2 text-sm">
              {isAr ? "تواصل معنا الآن وسنرد في أقل من 24 ساعة." : "Contact us now and we'll reply within 24 hours."}
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <p className="text-[#F0EDE8]/40 text-sm leading-relaxed">{t("common.description")}</p>
            <div className="flex items-center gap-2">
              {[
                { href: "https://wa.me/201000000000", icon: MessageCircle, title: t("common.whatsapp") },
                { href: "tel:+201000000000",           icon: Phone,          title: t("common.call") },
                { href: "mailto:info@royalnuts.com",   icon: Mail,           title: t("common.email") },
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                { Icon: MapPin, value: t("contact.location"),  href: "https://maps.google.com" },
                { Icon: Phone,  value: "+20 100 000 0000",      href: "tel:+201000000000" },
                { Icon: Mail,   value: "info@royalnuts.com",    href: "mailto:info@royalnuts.com" },
              ].map(({ Icon, value, href }) => (
                <li key={href}>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.07)", background: "rgba(0,0,0,0.25)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-[#F0EDE8]/25 text-xs">
            © {currentYear} {isAr ? "مصنع رويال للفول السوداني والسمسم. جميع الحقوق محفوظة." : "Royal Peanut & Sesame Factory. All Rights Reserved."}
          </p>
          <p className="text-[#F0EDE8]/25 text-xs">
